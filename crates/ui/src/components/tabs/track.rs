...
use super::config::{
    TAB_TRANSITION_SECS, UNDERLINE_INDICATOR_HEIGHT, UNDERLINE_INDICATOR_INSET_X,
...
impl TabTrackerAnimation {
    pub fn animate_indicator(
        ...
        let rel_x =
            ctx.animate_value_with_time(track_id.with("rel_x"), target_rel_x, TAB_TRANSITION_SECS);
