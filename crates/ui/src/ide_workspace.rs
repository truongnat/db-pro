// allow: IDE workspace operations remain a persisted contract while shell adoption is incremental.
#![allow(dead_code)]

use super::ide_workspace_scan::{flatten_index, scan_directory};
pub(crate) use super::ide_workspace_types::*;
