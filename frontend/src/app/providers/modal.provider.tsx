        ...
        return (
          ...
          >
            <Dialog.Portal>
              ...
              <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-[var(--radius-lg)] shadow-xl max-w-[600px] w-full max-h-[80vh] overflow-auto animate-in fade-in zoom-in-95 duration-200">
                <ModalComponent
                  {...entry.props}
