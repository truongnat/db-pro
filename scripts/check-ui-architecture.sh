...
for reducer in \
  ...
  "$repo_root/crates/ui/src/query_queue_events.rs"; do
...
for module in event_router agent_events connection_events operation_events schema_events table_events query_library_events query_prediction_events query_save_events query_history_events query_queue_events; do
