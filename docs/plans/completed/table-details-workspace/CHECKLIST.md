...
- [x] 8. Verify the full workspace after the current behavior slice; source/build/test gates pass, runtime screenshot recorded at `screenshots/table-data-grid-1280x800.png`.
