...
- [x] Form fields have explicit min/max width behavior.
...
- [x] Long cell/error/definition content has a deliberate wrap or truncate policy.
- [x] ER labels and controls remain usable in dense mode.

## Slice 5 — Verification

- [x] Run targeted UI tests.
- [x] Run Rust quality gates.
- [x] Capture runtime evidence at 1280x800 and 1440x900 across normal/dialog/error/loading/table/settings surfaces.
