...
## Lifecycle State
`OBSOLETE (frontend-era / archived React)`  
Archived: 2026-09-23  
Note: Frontend hooks and Tauri IPC commands are archived. Native query library/saved-query management is implemented in `crates/ui/`.
