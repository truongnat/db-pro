...
Archived: 2026-09-23  
Note: Targets the archived React frontend (`_archive/frontend/`). Native egui component modernizations are tracked under `native-core-ui-modernization` and `ui-component-language`.
