...
| Agent Workflow | main | — | IMPLEMENTING | Typed provider tool calls, bounded multi-step orchestration, executor/service boundary, run/session/document routing, stale-safe refresh, and confirmation pauses; native panel wiring and PostgreSQL/SQLite/live-provider evidence pending |
