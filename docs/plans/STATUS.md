...
| Table Data Editor Hardening | feature/table-data-editor-hardening | — | IMPLEMENTING | Stable original/composite PK identity, PK edits via original WHERE + final SET, composed staged updates, conflict/invariant affected-row handling, and native failure targeting implemented; provider/runtime/UI evidence pending |
