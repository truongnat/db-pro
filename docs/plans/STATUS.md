...
|---|---|---|---|---|
| Core Safety Hardening | feature/core-safety-hardening | — | IMPLEMENTING | Explain/mutation safety, SQLite and PostgreSQL operation deadlines, explicit PostgreSQL transaction rollback, SSH host-key/tunnel safety, SSH-aware backup, safe PostgreSQL user-management SQL, compensating connection lifecycle/secret cleanup, and checked pagination; provider live evidence pending |
