...
| Query Editor Intelligence Layer | main | — | IMPLEMENTING | Completion, delimiter UX, structured execution diagnostics, snapshot dirty state, saved-query update routing, local draft/history persistence, and ordered per-document multi-result output implemented; live provider and viewport evidence remain |
