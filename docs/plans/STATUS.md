...
| Agent Workflow | feature/agent-runtime-orchestration | — | IMPLEMENTING | Foundation contracts plus tested run state machine, mode/tool permissions, stale request guards, patch preview and confirmation state; runtime/UI orchestration and provider evidence pending |
