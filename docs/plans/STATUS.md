...
|---|---|---|---|---|
| Core Safety Hardening | feature/core-safety-hardening | — | IMPLEMENTING | Explain policy, zero-row mutation errors, SQLite interrupt timeout, SSH host-key verification, and SSH-aware PostgreSQL backup; provider live evidence pending |
