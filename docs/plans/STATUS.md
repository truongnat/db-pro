...
| Native Visual Redesign | IMPLEMENTING | goal-2.md Waves 1–4 native shell, full-window startup, shared data-grid and context-aware status polish on `feature/native-visual-redesign`; runtime evidence recorded, follow-up interaction/provider review remains |
