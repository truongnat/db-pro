...
| Native Visual Redesign | IMPLEMENTING | goal-2.md Waves 1–3 native shell, full-window startup and shared data-grid polish on `feature/native-visual-redesign`; runtime evidence recorded, follow-up interaction/provider review remains |
