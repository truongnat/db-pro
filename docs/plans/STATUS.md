...
| Explorer First-Tab Visual Redesign | main | — | RUNTIME_VERIFY | Merged as `a9efb730`. Research used as a source inventory, not an implementation commitment. Added connection-group hierarchy, active-row treatment, and visible connecting hint. fmt/check/clippy/workspace tests/release build pass. Captures collected; host height caps 1440×900 and 1920×1080, connected/error visuals pending. Plan: docs/plans/active/explorer-first-tab-redesign/ |
| Component Gallery Redesign | feature/component-gallery-redesign | — | RUNTIME_VERIFY | Vertical workstation library replaces the clipped 14-item category track and monolithic All view; one category renders at a time; shared Card uses semantic 4px/no-shadow styling; 679 UI tests, workspace check/clippy and locked native release build pass. Captures exist for requested 1280×800, 1440×900 and 1920×1080; macOS caps the latter two at 838 logical px height, so full-height evidence and independent review remain pending. Plan: docs/plans/active/component-gallery-redesign/ |
| Welcome + Query Editor Polish | cursor/welcome-query-editor-polish-e577 | — | RUNTIME_VERIFY | Welcome start block inset and paired cards; empty Explorer hides the object filter; query Run/Explain/Format moved onto the editor toolbar. UI captures at 1280×800, 1440×900, 1920×1080. Workspace clippy/test suite not run. Plan: docs/plans/active/welcome-query-editor-polish/ |
