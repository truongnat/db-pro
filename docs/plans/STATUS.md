...
| Query Editor Intelligence Layer | main | — | IMPLEMENTING | Per-document connection/schema and execution routing; async AI prediction runtime boundary, debounce, cancellation, context limits, and stale-response protection in progress |
