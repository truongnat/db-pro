...
| Agent Workflow | main | — | IMPLEMENTING | Typed tool contracts, executor/service boundary, runtime command/event routing, bounded schema/result outputs, and confirmation enforcement; provider loop and native PostgreSQL/SQLite evidence pending |
