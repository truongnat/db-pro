...
| Agent Workflow | feature/agent-workflow | — | IMPLEMENTING | Foundation contracts added for typed session/context/action/tool/patch models, bounded context, and safety-gated execution; runtime/UI orchestration and provider evidence pending |
