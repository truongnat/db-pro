...
- [x] Re-run `cargo test -p db-pro-core -p db-pro-ui` after merge
- [x] Re-run `cargo clippy -p db-pro-core -p db-pro-ui --all-targets -- -D warnings` after merge
- [x] Re-run `cargo fmt --all -- --check` after merge
