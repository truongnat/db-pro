...
- `cargo test -p db-pro-core application::connection_service::tests` — PASS: 35
...
- `cargo test -p db-pro-core --no-fail-fast` — PASS: 234 core unit tests,
...
- `cargo test --workspace` — PASS: 234 core unit, 28 SQLite integration, 48
