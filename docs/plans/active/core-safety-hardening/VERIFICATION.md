...
- `cargo test -p db-pro-core domain::safety::tests` — PASS: 33 safety classifier
...
- `cargo test -p db-pro-core --no-fail-fast` — PASS: 245 core unit tests,
...
- `cargo test --workspace` — PASS: 245 core unit, 28 SQLite integration, 54
